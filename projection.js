...
function operate() {
    ...
    let mod2 = ((vector2[0] ** 2) + (vector2[1] ** 2)) ** 0.5;
    let dP1 = ((vector1[0] * vector2[0]) + (vector1[1] * vector2[1]));
    let sP = dP1 / (mod2 *mod2);

    vector3[0] = vector2[0] * sP;
    vector3[1] = vector2[1] * sP;
...
function updateVectorSvg() {
    ...
    line6.setAttribute("x1", bigVector1[0].toString());
    line6.setAttribute("y1", bigVector1[1].toString());
    line6.setAttribute("x2", bigVector3[0].toString());
    line6.setAttribute("y2", bigVector3[1].toString());
    ...
    line4.setAttribute("x1", bigDisplace);
    line4.setAttribute("y1", bigDisplace);
    line4.setAttribute("x2", bigVector2[0].toString());
    line4.setAttribute("y2", bigVector2[1].toString());
